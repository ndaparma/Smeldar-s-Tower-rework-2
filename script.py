...
#2.TOWN  *********************************
line201 = "You stand at the center of TOWN and breath in the smells of the market and nearby fountain.\n" #16
  #EXPLORE
...
line506 = '"Nobel ADVENTURER, hear my plea; our kingdom has been plagued by the evil warlock SMELDAR since it was founded many generations ago. His TOWER is a harbinger of dark times and appears whenever SMELDAR begins assembling his wicked army. Please venture NORTH through the FOREST to the wretched TOWER and put a stop to SMELDAR before his power returns and he regains his full strength"\n' #62
line507 = '"Nobel ADVENTURER I hope your quest goes well. We all pray for your safety and success in your journey. Please defeat the evil warlock SMELDAR and save our kingdom from darkness."\n' #63
line508 = '"I see you carry our kingdoms symbol of the HERO. A shame such an honorable WARRIOR has fallen. We will make sure to honor his memory. Please keep the medal as a token of your service and allow me to unlock its magical properties."\n' #64
#6.CLIFF*************************
...
#11.SHRINE*******************************
line1101 = "You approach a dingy SHRINE tucked away in the woods. A FRIAR stops his prayer and slowly stands up to greet you. Type SPEAK to interact.\n" #166
  #EXPLORE
...
#12.RIVER******************************
line1201 = "You follow the path until you reach a stump at a T intersection near the bank of the RIVER. You take a seat while you decide your next actions.\n" #202
  #EXPLORE
line1202 = "The RIVER runs from the highlands SOUTH to the NORTH providing a natural border between the woods in the EAST and the lands WEST.  The RIVER is too deep to wade through and too wide and swift to saftely swim across. The water is clear and you can see the shimmering RIVER rocks lining the bottom of the RIVER bed. You can also see some fish fighting the current, heading upstream.\n" #206
  #NORTH
line1203 = "You take the NORTH path following the RIVER downstream.\n" #214
  #EAST
line1204 = "You start walking EAST and head back into the FOREST.\n" #217
  #SOUTH
line1205 = "You take the SOUTH path following the RIVER upstream.\n" #220
  #WEST
...
line1408 = "You stare at the remnants of the mangled MANDRAGORA. The sap dripping from its broken stems and tattered petals make for a shockingly distrubing sight. Best to keep going and not think about how you murdered an endangered species.\n" #268
  #NORTH
line1409 = "You keep on walking along the LAKE shore NORTH to the floating BOAT house.\n" #270
  #EAST
line1410 = "Your path is blocked by a massive FLOWER. You've never seen anything like it in your travels before. EXAMINE it for a closer look?\n" #272
line1411 = "You continue on the cleared path and re-enter the woods.\n" #273
  #SOUTH
line1412 = "You turn and follow the RIVER back downstream.\n" #275
  #WEST
line1413 = "As inviting as the water looks, all this equipment might make it hard to swim. Better not try it.\n" #277
line1414 = "Staring at the prestine LAKE water under the hot sun, you can't help yourself and dive in. You sink straight to the bottom. Forgot you had too much gear on you?\n" #278
#15.BOAT*******************************
...
line1604b = "The corpse is still there, slowly being consumed by the MUSHROOMS. Not the most nobel way to go...\n"
  #North
line1605 = "A thick cloud of spores clouds the way NORTH making passage impossible.\n" #321
  #EAST
line1606 = "The MUSHROOMS here have grown into a thick wall blocking any travel to the EAST.\n" #324
  #SOUTH
line1607 = "You try walking SOUTH but the foliage is much to dense to get through, even with an AXE.\n" #327
  #WEST
line1608 = "You back out of the MUSHROOM grove and head WEST towards the LAKE.\n" #330
#17.MEADOW**************************
